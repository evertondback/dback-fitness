...
import {ANATOMY_CALLOUT_DELEGATE_CSS,ANATOMY_CALLOUT_DELEGATE_JS} from './v21-anatomy-callout-delegate.js';
...
function patch(html){
 let out=html.replaceAll('9.4.0',VERSION).replaceAll('9.3.0',VERSION).replaceAll('9.2.0',VERSION).replaceAll('9.1.0',VERSION).replaceAll('9.0.2',VERSION).replaceAll('9.0.1',VERSION).replaceAll('8.1.0',VERSION).replaceAll('8.0.1',VERSION).replaceAll('8.0.0',VERSION).replaceAll('7.0.2',VERSION).replaceAll('7.0.1',VERSION).replace('</style>',CSS+HISTORY_CSS+ANATOMY_SORT_CSS+RESPONSIVE_CSS+LAYOUT_HOTFIX_CSS+EQUIPMENT_LIBRARY_CSS+ANATOMY_SVG_CSS+LIBRARY_INDEX_CSS+ANATOMY_PRO_CSS+ANATOMY_UX_CSS+ANATOMY_REFERENCE_CSS+ANATOMY_MOBILE_FIX_CSS+ANATOMY_STUDIO_CSS+ANATOMY_DETAIL_FIX_CSS+ANATOMY_CALLOUT_DELEGATE_CSS+VIDEO_SOURCE_CSS+VIDEO_LIBRARY_CSS+COLLAPSE_CSS+'</style>').replace('</body>','<script>'+CORE_JS+'</script><script>'+HISTORY_JS+'</script><script>'+ANATOMY_SORT_JS+'</script><script>'+RESPONSIVE_JS+'</script><script>'+EQUIPMENT_LIBRARY_JS+'</script><script>'+ANATOMY_SVG_JS+'</script><script>'+LIBRARY_INDEX_JS+'</script><script>'+ANATOMY_PRO_JS+'</script><script>'+ANATOMY_UX_JS+'</script><script>'+ANATOMY_REFERENCE_JS+'</script><script>'+ANATOMY_MOBILE_FIX_JS+'</script><script>'+ANATOMY_STUDIO_JS+'</script><script>'+ANATOMY_STUDIO_NAV_FIX_JS+'</script><script>'+ANATOMY_DETAIL_FIX_JS+'</script><script>'+ANATOMY_CALLOUT_DELEGATE_JS+'</script><script>'+VIDEO_SOURCE_JS+'</script><script>'+VIDEO_LIBRARY_JS+'</script><script>'+COLLAPSE_JS+'</script></body>');
