export const PROGRAM_VERSION='31.0.0';
...
export const PROGRAM31={
 ...
 Wednesday:{focus:'Unilateral Strength + Balance',intensity:'Moderate-Hard',targetMinutes:60,exercises:[
  E('bulgarian','Bulgarian Split Squat',3,'8 / side',90,2,VIDEO.bulgarian,'dumbbells','3-1-1'),E('sl-rdl','Single-Leg Romanian Deadlift',3,'8 / side',75,2,VIDEO.slrdl,'dumbbells','3-1-1'),E('chinup','Chin-Up',3,'5-8',90,2,VIDEO.pull),E('press-we','One-Arm Dumbbell Floor Press',3,'8 / side',75,2,VIDEO.press,'dumbbell'),E('row-we','One-Arm Dumbbell Row',3,'8-10 / side',75,2,VIDEO.row,'dumbbell'),E('bird-we','Bird Dog',2,'8 / side',30,4,VIDEO.bird,'bodyweight','controlled','core')
 ]},
 Thursday:{focus:'Recovery + Mobility + Structural Posture',intensity:'Recovery',targetMinutes:60,exercises:[
  E('cat','Cat-Cow',2,'8',30,null,VIDEO.cat,'bodyweight','controlled','mobility'),E('thor','Thoracic Rotation',2,'8 / side',30,null,VIDEO.thor,'bodyweight','controlled','mobility'),E('hip90','90/90 Hip Rotation',2,'8 / side',30,null,VIDEO.hip,'bodyweight','controlled','mobility'),E('wall','Wall Slide',2,'10',30,4,VIDEO.wall,'bodyweight','controlled','posture'),E('bridge-th','Glute Bridge',3,'12',30,4,VIDEO.bridge),E('deadbug-th','Dead Bug',3,'6 / side',30,4,VIDEO.deadbug,'bodyweight','controlled','core'),E('rdl-th','Light Dumbbell RDL',2,'12',45,4,VIDEO.rdl,'dumbbells')
 ]},
 Friday:{focus:'Heavy Strength + Power',intensity:'Heavy',targetMinutes:60,exercises:[
  E('pushpress','Dumbbell Push Press',4,'5-6',90,2,VIDEO.pushpress,'dumbbells','explosive','power'),E('rdl-fr','Dumbbell Romanian Deadlift',3,'6-8',90,2,VIDEO.rdl,'dumbbells','3-1-1'),E('squat-fr','Double-Dumbbell Front Squat',3,'6-8',90,2,VIDEO.squat,'dumbbells','3-1-1'),E('pull-fr','Pull-Up',3,'5-8',90,2,VIDEO.pull),E('press-fr','Dumbbell Floor Press',3,'6-10',90,2,VIDEO.press,'dumbbells'),E('row-fr','One-Arm Dumbbell Row',3,'8-10 / side',75,2,VIDEO.row,'dumbbell'),E('farmer','Farmer March',3,'45 sec',60,2,VIDEO.farmer,'dumbbells'),E('drag','Plank Dumbbell Drag',3,'8 / side',45,2,VIDEO.drag,'dumbbell','controlled','core'),E('hollow','Hollow Hold',3,'20-40 sec',45,2,VIDEO.hollow,'bodyweight','controlled','core')
 ]},
 Saturday:{focus:'Full Body + Arms + Conditioning',intensity:'Moderate',targetMinutes:60,exercises:[
  E('goblet-sa','Goblet Squat',3,'8-12',75,2,VIDEO.goblet,'dumbbell'),E('press-sa','Dumbbell Floor Press',3,'8-12',75,2,VIDEO.press,'dumbbells'),E('row-sa','One-Arm Dumbbell Row',3,'8-12 / side',75,2,VIDEO.row,'dumbbell'),E('lunge-sa','Reverse Lunge',3,'8-10 / side',60,2,VIDEO.lunge,'dumbbells'),E('rdl-sa','Romanian Deadlift',3,'8-12',75,2,VIDEO.rdl,'dumbbells'),E('curl-sa','Hammer Curl',3,'10-12',45,2,VIDEO.curl,'dumbbells','controlled','accessory'),E('tri-sa','Dumbbell Triceps Extension',3,'10-12',45,2,VIDEO.tri,'dumbbell','controlled','accessory'),E('hollow-sa','Hollow Hold',3,'20-40 sec',45,2,VIDEO.hollow,'bodyweight','controlled','core')
 ]}
};
