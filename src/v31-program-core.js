export const PROGRAM_VERSION='36.2.0';
...
export const PROGRAM31={
 ...
 Monday:{focus:'Heavy Strength + Posture + Direct Abs',intensity:'Heavy',targetMinutes:60,exercises:[
  E('front-squat','Double-Dumbbell Front Squat',3,'6-8',90,2,VIDEO.squat,'dumbbells','3-1-1'),E('pullup','Pull-Up or Chin-Up',3,'5-8',90,2,VIDEO.pull),E('floor-press','Dumbbell Floor Press',3,'6-10',90,2,VIDEO.press,'dumbbells','3-0-1'),E('row','One-Arm Dumbbell Row',3,'8-10 / side',75,2,VIDEO.row,'dumbbell'),E('rdl','Dumbbell Romanian Deadlift',3,'8-10',90,2,VIDEO.rdl,'dumbbells','3-1-1'),E('half-ohp','Half-Kneeling One-Arm Overhead Press',3,'8 / side',60,2,VIDEO.ohp,'dumbbell'),E('suit-march','Suitcase March',3,'40 sec / side',60,2,VIDEO.suit,'dumbbell'),E('side-plank','Side Plank',3,'30-45 sec / side',45,2,VIDEO.side),E('reverse-crunch-mo','Reverse Crunch',3,'10-15',45,2,VIDEO.reverseCrunch,'bodyweight','2-1-2','core')
 ]},
 Tuesday:{focus:'Hypertrophy + Conditioning + Direct Abs',intensity:'Moderate-Hard',targetMinutes:60,exercises:[
  E('goblet','Goblet Squat',3,'8-12',75,2,VIDEO.goblet,'dumbbell','3-1-1'),E('pushup-tu','Push-Up',3,'8-15',60,2,VIDEO.pushup),E('rev-lunge','Reverse Dumbbell Lunge',3,'8-10 / side',75,2,VIDEO.lunge,'dumbbells'),E('row-tu','Bent-Over Dumbbell Row',3,'8-12',75,2,VIDEO.row,'dumbbells'),E('press-tu','Dumbbell Floor Press',3,'8-12',75,2,VIDEO.press,'dumbbells'),E('lat','Dumbbell Lateral Raise',3,'12-15',45,2,VIDEO.lat,'dumbbells','controlled','accessory'),E('curl','Hammer Curl',3,'10-12',45,2,VIDEO.curl,'dumbbells','controlled','accessory'),E('tri','Dumbbell Triceps Extension',3,'10-12',45,2,VIDEO.tri,'dumbbell','controlled','accessory'),E('thruster','Dumbbell Squat-to-Press',3,'10',45,3,VIDEO.thruster,'dumbbells','controlled','conditioning'),E('reverse-crunch-tu','Reverse Crunch',3,'12-15',45,2,VIDEO.reverseCrunch,'bodyweight','2-1-2','core')
 ]},
 ...
 Friday:{focus:'Heavy Strength + Upper/Lower Power + Core',intensity:'Heavy',targetMinutes:60,exercises:[
