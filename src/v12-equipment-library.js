...
function homeEquipment(){const v=q('#view-home');if(!v||getComputedStyle(v).display==='none'||v.querySelector('.dbHomeEquip'))return;const d=document.createElement('div');d.className='card dbHomeEquip';d.innerHTML='<h3>Home Equipment</h3><div><span class="dbEquipTag">2 Adjustable Dumbbells · 5–55 lb each</span><span class="dbEquipTag">Pull-Up Bar</span><span class="dbEquipTag">Floor Mat</span><span class="dbEquipTag">Bodyweight</span></div><div class="muted">Programming should use all available equipment across the week.</div>';const h=v.querySelector('.hero');if(h)h.after(d)}
